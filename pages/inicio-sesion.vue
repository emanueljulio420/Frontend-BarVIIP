        ...
        <div class="container">
            ...
            <v-card class="my-5 text-center mx-auto transparent-card" min-width="400" min-height="300">
                ...
                <form class="mx-5" action="#" @submit.prevent="handleSubmit()">
                    <v-row>
                        <v-col cols="12">
                            <v-text-field v-model="email" :rules="[rules.required, rules.correo]" label="Correo"
                                variant="outlined" requiered />
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="12"><v-text-field v-model="password" :rules="[rules.required]" label="Contraseña"
                                type="password" placeholder="Contraseña" variant="outlined" requiered />
                        </v-col>
                    </v-row>
